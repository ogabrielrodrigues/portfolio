...
export default function Menu() {
  ...
  function toggleMenu() {
    ...
    menuWrapper?.classList.toggle('-translate-y-0')
  ...
  return (
    <>
      <MenuIcon
        ...
        height={32}
        onClick={toggleMenu}
        className="z-50 transition-transform md:hidden"
        ref={menuRef}
      />

      <div
        className="absolute left-0 top-0 h-full w-full -translate-y-full bg-gradient transition-transform"
        ref={menuWrapperRef}
      >
